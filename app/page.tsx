        ...
        <div className="container flex flex-col md:flex-row items-center justify-between gap-12 py-20">
          <div className="relative col z-10 max-w-4xl mx-auto px-6 text-center">
            <div className="mb-8">
              ...
              <h1 className="text-5xl !font-normal md:text-7xl bg-gradient-to-r from-cosmic-deep via-cosmic-royal to-cosmic-deep bg-clip-text mb-6 leading-tight">
                Awaken Your <span className="text-[#D6BD98]">Soul's Journey</span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a href="https://wa.me/919843948288">
                <Button variant="cosmic" size="lg" className="group bg-[#D6BD98] hover:!bg-white  !font-medium !text-black">
          ...
          <div className="col">
            <Card className="bg-white/10 backdrop-blur-lg shadow-2xl rounded-2xl border-0">
              <form className="relative flex flex-col gap-5 max-w-md mx-auto p-8 bg-transparent rounded-2xl"
                ...
                <button
                  type="submit"
                  className="mt-5 bg-[#D6BD98] hover:!bg-white  !font-medium text-black hover:bg-cosmic-sunset text-lg px-6 py-3 rounded-lg shadow-lg transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-cosmic-gold/50 focus:ring-offset-2"
    ...
    return (
      <section className="py-10 bg-gradient-to-r from-cosmic-deep via-cosmic-royal to-cosmic-deep relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <a href="#hero">
            <Button variant="cosmicOutline" size="lg" className="!bg-[#D6BD98] !font-medium text-black border-black hover:!bg-[var(--foreground)] hover:!text-[var(--background)]  hover:text-cosmic-deep backdrop-blur-sm mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <a href="#hero">
              <Button
                ...
                size="lg"
                className="text-cosmic-deep hover:bg-cosmic-gold text-lg px-6 py-4 h-auto group !bg-[#D6BD98] !font-medium !text-black hover:!bg-[var(--foreground)] ">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <a href="#hero">
              <Button
                variant="cosmicOutline"
                size="lg"
                className="!bg-[#D6BD98] hover:!bg-white !font-medium !text-black text-xl px-8 py-6  hover:scale-105 transform-all transition duration-300">
                <span className="mr-3">👉</span>
